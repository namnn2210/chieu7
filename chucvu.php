...
if (isset($_POST['addButton'])) {
    ...
    // Insert data into the 'chucvu' table
    $sql = "INSERT INTO chucvu (ten) VALUES ('$name')";
...
if (isset($_POST['searchButton'])) {
    ...
    $sql = "SELECT * FROM chucvu WHERE name LIKE '%$searchTerm%'";
} else {
...
<div id="inputSection">
    <div class="input-container">
        <div class="input-row">
            <input type="text" class="input-field" id="name" placeholder="Tên chức vụ">
        </div>
        <div class="input-row">
