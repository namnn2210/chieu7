...
if (isset($_POST['addButton'])) {
    ...
    // Insert data into the 'loaisanpham' table
    $sql = "INSERT INTO loaisanpham (ten) VALUES ('$name')";
...
if (isset($_POST['searchButton'])) {
    ...
    $sql = "SELECT * FROM loaisanpham WHERE name LIKE '%$searchTerm%'";
} else {
...
<div id="inputSection">
    <div class="input-container">
        <div class="input-row">
            <input type="text" class="input-field" id="name" placeholder="Tên loại sản phẩm">
        </div>
        <div class="input-row">
