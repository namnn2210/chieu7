...
if (isset($_POST['addButton'])) {
    ...
    // Insert data into the 'donvitinh' table
    $sql = "INSERT INTO donvitinh (ten,ki_hieu) VALUES ('$name','$signature')";
...
if (isset($_POST['searchButton'])) {
    ...
    $sql = "SELECT * FROM donvitinh WHERE name LIKE '%$searchTerm%'";
} else {
...
<div id="inputSection">
    <div class="input-container">
        <div class="input-row">
            <input type="text" class="input-field" id="name" placeholder="Tên đơn vị tính">
        </div>
        <div class="input-row">
            <input type="text" class="input-field" id="signature" placeholder="Kí hiệu">
        </div>
        <div class="input-row">
